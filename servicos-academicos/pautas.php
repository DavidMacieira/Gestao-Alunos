...
<div class="page-body">
    ...
    <div class="page-hd">
        ...
        <a href="criar_pauta.php" class="btn btn-primary">
    ...
    <div class="card">
        <?php if (empty($pautas)): ?>
            <div class="empty-state">
                ...
                <a href="criar_pauta.php" style="color:var(--green);font-weight:500;margin-top:8px;display:inline-block;">Criar a primeira pauta</a>
            </div>
        <?php else: ?>
